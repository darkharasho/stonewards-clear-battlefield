...
# Keep in sync with the <Reference> items in src/ClearBattlefield/ClearBattlefield.csproj.
game_dlls=(Assembly-CSharp Mirror Unity.InputSystem UnityEngine UnityEngine.CoreModule UnityEngine.InputLegacyModule
